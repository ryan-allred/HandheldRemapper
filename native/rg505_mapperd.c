...
static void cfg_defaults(Config *c) { memset(c,0,sizeof(*c)); strcpy(c->event_name,"Xbox Wireless Controller"); strcpy(c->output_name,"RG505 D-pad WASD"); strcpy(c->output_mouse_name,"RG505 Mapper Mouse"); strcpy(c->mouse_axis_x,"ABS_Z"); strcpy(c->mouse_axis_y,"ABS_RZ"); c->mouse_center_x=0; c->mouse_center_y=0; c->mouse_min_x=-32768; c->mouse_max_x=32767; c->mouse_min_y=-32768; c->mouse_max_y=32767; c->mouse_deadzone=200; c->mouse_speed=1; c->mouse_interval_ms=8; }
